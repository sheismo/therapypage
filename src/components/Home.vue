...
export default {
    data () {
        return{
            title: "Meet a Shrink, Get it fixed.",
            msg: "Let's Fix it together."
        }
    }
...
.btn:hover{
    background-color: rgb(11, 134, 206);
...
.btn-b{
    text-align: center;
    color: white;
    background-color: rgb(244, 122, 248);
    padding: 13px 70px;
    outline: none;
    border: none;
    border-radius: 2px;
...
.btn-b:hover{
    background-color: rgb(236, 63, 241);
    box-shadow: 2px 2px 2px #bbb;
}
